...
1. The core features of Node.js and Express and why they are useful.
   Allows JS outside of the browser to set up a server and Express to extend functionality.

1. Understand and explain the use of Middleware.
   Middleware performs on or verifies what's being passed into req and res before getting to an endpoint.

1. The basic principles of the REST architectural style.
   REST as a client-server architecture....

- is stateless, session state is kept entirely on the client's side.
- is cacheable, this improves performance.
- provides a uniform interface between components.
- is layered, meaning a client can only see the immediate layer and not beyond, allowing each component to be independent and replaceable.

1. Understand and explain the use of Express Routers.
   Express router is a framework for Node which helps us create route handlers.

1. Describe tooling used to manually test the correctness of an API.
   Tools such as postman allow us to perform CRUD operations to see if the output is what we're expecting it to be.
